...
<html lang="zxx">
<head>
<title>Shoppy admin panel| Home |delete</title>
<!-- custom-theme -->
					...
					<nav class="gn-menu-wrapper">
						<div class="gn-scroller scrollbar1">
							<ul class="gn-menu agile_menu_drop">
								...
								<li><a href="complains.jsp"> <i class="fa fa-line-chart" aria-hidden="true"></i> Complaints And Returns</a></li>
							...
							<div class="agile_top_w3_post_sections">
							       <div class="col-md-6 agile_top_w3_post agile_info_shadow">
										   <div class="img_wthee_post">
										         <h3 class="w3_inner_tittle">Delete Product</h3>
