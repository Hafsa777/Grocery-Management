    ...
    <body>
        ...
        <%!
            public class Supplier {
                ...
                PreparedStatement selectSupplier = null;
                ...
                public Supplier() {
                    ...
                    try {
                        ...
                        selectSupplier = connection.prepareStatement("SELECT sid,name,address,email,pid,phoneNo,quantity FROM grocery.supplier");
                ...
                public ResultSet getSuppliers() {
                    try {
                        resultSet = selectSupplier.executeQuery();
                    } catch (SQLException e) {
                        e.printStackTrace();
                    }
        ...
        <%
            ...
            ResultSet suppliers = supplier.getSuppliers();
        %>
        <!-- banner -->
                    ...
                    <div class="agile_top_w3_post_sections">
                        <div class="col-md-6 agile_top_w3_post agile_info_shadow">
                            <div class="img_wthee_post">
                                ...
                                <h1>Generate E-mail</h1>
        
        <h4> Please Insert the information </h4>
        <form name="myForm" action="reorderReport.jsp" method="POST">
            <table border="0">
                <tbody>
                    <tr>
                        <td> Supplier  : </td>
                        <td><input type="text" name="supplier" value="" size="50" /></td>
                    </tr>
                    <tr>
                        <td> Product :</td>
                    ...
                    <tr>
                        <td> Supply Date  : </td>
                        <td><input type="text" name="suppD" value="MM/DD/YYYY" size="15" /></td>
                    </tr>
                    <tr>
                        <td> Quantity : </td>
                        <td><input type="text" name="quan" value="" size="10" /></td>
                    </tr>
                    <tr>
                        <td>Time Line To Reply </td>
                        <td><input type="text" name="tl" value="" size="20" /></td>
                    </tr>
                </tbody>
            </table>
            ...
            <input type="submit" value="Submit" name="submit" />
                                ...
                                <div class="stats-wrap">
                                    ...
                                    <div class="year-info"><p class="text-no"><a href="Supplier.jsp">back</a></p><span class="year"></span></div>
                                    <div class="clearfix"></div>
                                </div>
