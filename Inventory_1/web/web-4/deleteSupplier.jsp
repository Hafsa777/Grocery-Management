                ...
                public class deleteEmp{
                        ...
                        public deleteEmp(){
                           try{  
                                  ...
                                  query = "delete  from supplier where sid=?";
                       ...
                       public int SetNames(String sid){
							...
							<div class="agile_top_w3_post_sections">
							       <div class="col-md-6 agile_top_w3_post agile_info_shadow">
										   <div class="img_wthee_post">
										         <h3 class="w3_inner_tittle">Delete Supplier Details</h3>
												<form  name = "deleteSupplier" action = "deleteSupplier.jsp" method = "POST">
