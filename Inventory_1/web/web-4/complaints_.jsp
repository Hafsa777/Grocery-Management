							...
							<div class="agile_top_w3_post_sections">
							       <div class="col-md-6 agile_top_w3_post agile_info_shadow">
										   <div class="img_wthee_post">
												...
												<div style="background-color:burlywood;height:100px">
        <h1><center>Complaints and Returns Management</center></h1>
        </div>
        <div style="background-color:bisque;height:50px ">
           <h1><center> Make complaints</center></h1>
        </div><br><center><table width="400" height="300" >
        <form action="insertcomplaints.jsp" method="POST">
            <tr><td> Administrator/Customer Name :</td>
                <td><input type="text" name="name" value="" /></td></tr>
            <tr><td>Administrator/Customer ID :</td>
                <td><input type="text" name="id" value="" /></td></tr>
            <tr><td> Complain Type   :</td>
                <td>  <select name="-----select type---">
                    <option>-----select------</option>
                    <option>Returns/other/overstock</option>
                    <option>Returns defected product</option>
                    <option>product expired</option>
                    </select></td></tr>
            <tr><td>Complain Title       :</td>
                <td><input type="text" name="title" value="" /></td></tr>
            <tr><td>Complain Description :</td>
                <td><textarea name="description" rows="4" cols="20"></textarea></td></tr>
            <tr><td> <input type="Submit" value="submit" name="submit" /></td>
                <td><input type="button" value="cancel" name="Delete" /></td>
                <td><input type="button" value="Exit" name="submit" /></td>
            </tr>
        </form></table></center>
													...
													<div class="clearfix"></div>
                                                                                         ...
                                                                                         <div class="stats-wrap">
													<div class="count_info"><h4 class="count"></h4><span class="year"></span></div>
                                                                                                        <div class="year-info"><p class="text-no"><a href="Complains.jsp">back</a></p><span class="year"></span></div>
													<div class="clearfix"></div>
												</div>
