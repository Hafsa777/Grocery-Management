...
<body>
	...
	<div class="privacy">
		<div class="container">
			...
			<div class="checkout-right">
				...
				<div class="table-responsive">
					<table class="timetable_sub">
						...
						<tbody>
							...
							<tr class="rem2">
								<td class="invert"> <%=request.getParameter("item")%></td>
								...
								<td class="invert"> <%=request.getParameter("price")%></td>
								<td class="invert">
									<div class="rem">
				...
				<div class="address_form_agile">
					...
					<table class="timetable_sub">
								...
								<td class="invert">Final Payment</td>
								<td class="invert"> <%=request.getParameter("subTotal")%></td>
								
							</tr>
                                                
                                                  <tr class="rem2">
                                                                
								<td class="invert">Shipping Price</td>
								<td class="invert">Rs 200</td>
								
							</tr>
                                                          <tr class="rem2">
                                                                
								<td class="invert">Tax</td>
								<td class="invert"> Rs.100</td>
			...
			<div class="checkout-left">
				<div class="address_form_agile">
					<h4>Confirm the Delivery Details</h4>
					<form action="invoice.jsp" method="post" class="creditly-card-form agileinfo_form">
								...
								<div class="first-row">
									...
									<div class="w3_agileits_card_number_grids">
										...
										<div class="w3_agileits_card_number_grid_right">
											<div class="controls">
												<input type="text" placeholder="Address" name="landmark" required="">
											</div>
										</div>
										<div class="clear"> </div>
									</div>
