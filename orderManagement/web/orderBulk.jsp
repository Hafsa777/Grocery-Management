   ...
   <% if (session.getAttribute("user_name") != null) { %>
    ...
    public class myCart{
            ...
            try{
                ...
                query = "select image,pid,name,sellPrice,quantity,weight from product ";
...
%>
     ...
     <% while(cart.next())  { %>
     <div class="mycart">
         <form name="item" action="bCart.jsp?action=add&id=<%= cart.getString("pid") %>" method="POST">
          <div id="cat">
             ...
             <h4 class="text-price"><%= cart.getDouble("discount") %></h4>
