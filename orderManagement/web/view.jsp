...
<%!
    public class category{
            ...
            try{
                ...
                query = "select image,pid,name,sellPrice,weight from product where pid=?";
           ...
           public ResultSet getCategory(String id){
            ...
            <%
                ...
                type = request.getAttribute("id").toString();
     ...
     <div class="mycart">
         <form name="item" action="cart.jsp" method="POST">
          <div id="cat">
             ...
             <h4 class="text-weight"><%= cart.getDouble("description") %></h4>
