			...
			<div class="agileits-navi_search">
				<form action="category.jsp" method="post">
					<select id="agileinfo-nav_search" name="agileinfo_search" required="">
						...
						<option value="Kitchen">Beverages</option>
						<option value="Household">Chocolates</option>
						<option value="Snacks &amp; Beverages">Biscutis</option>
						<option value="Personal Care">Candies</option>
						<option value="Gift Hampers">Beverages</option>
			...
			<div class="footer-info w3-agileits-info">
				...
				<div class="col-sm-5 address-right">
					<div class="col-xs-6 footer-grids">
						...
						<ul>
							<li>
								<a href="snack.jsp">Snacks & Biscuits</a>
							</li>
							<li>
