							       ...
							       <div class="col-md-6 agile_top_w3_post agile_info_shadow">
										   <div class="img_wthee_post">
												...
												<div class="stats-wrap">
													<div class="count_info"><h4 class="count">Welcome </h4><span class="year"></span></div>
                                                                                                        <div class="year-info"><p class="text-no"><a href="welcome.jsp">welcome</a></p><span class="year"></span></div>
													<div class="clearfix"></div>
												</div>
												<div class="stats-wrap">
													<div class="count_info"><h4 class="count">Insert </h4><span class="year"></span></div>
                                                                                                        <div class="year-info"><p class="text-no"><a  href="insertdata.jsp">insert</a></p><span class="year"></span></div>
													<div class="clearfix"></div>
												</div>
                                                                                         
                                                                                                <div class="stats-wrap">
													<div class="count_info"><h4 class="count">complaints</h4><span class="year"></span></div>
                                                                                                        <div class="year-info"><p class="text-no"><a href="complaints_.jsp">complaint</a></p><span class="year"></span></div>
													<div class="clearfix"></div>
												</div>
