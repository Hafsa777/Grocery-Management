  ...
  <%! 
        public class retailOrder{
            ...
            public retailOrder(){
                ...
                query = "select c.addressLine1 ,c.addressLine2 ,c.email ,c.phoneNo,o.oid,o.date,o.item,o.quantity,o.total from login l ,customer c ,order_bulk o where l.cid = c.cid and c.cid = o.cid  and l.username=?";
