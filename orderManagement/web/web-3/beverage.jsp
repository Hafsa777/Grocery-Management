				...
				<div class="wrapper">
					...
					<div class="product-sec1">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
                                                                    ...
                                                                    <img src="images/images.jpg" width="100" height="150"/>
								...
								<div class="item-info-product ">
									<h4>
										<a href="view.jsp">Sprite, 500ml</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">lkr450.00</span>
									...
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="cart.jsp" method="post">
											<fieldset>
												...
												<input type="hidden" name="hidden_name" value="Sprite, 500ml" />
												<input type="hidden" name="hidden_price" value="450.00" />
												<input type="hidden" name="hidden_id"  value="007" />
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
                                                                   <img src="images/BodyArmor-Lyte-SuperDrink-Beverage-Industry.jpg" width="100" height="150"/>
								...
								<div class="item-info-product ">
									<h4>
										<a href="view.jsp">Body Armour, 150ml</a>
									</h4>
									<div class="info-product-price">
									...
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="cart.jsp" method="post">
											<fieldset>
												<input type="hidden" name="quantity" value="1" />
												<input type="hidden" name="hidden_name" value="Body Armour, 150ml" />
												<input type="hidden" name="hidden_price" value="200.00" />
												<input type="hidden" name="hidden_id"  value="008" />
												<input type="submit" name="add_to_cart" value="Add to cart" class="button" />
											</fieldset>
										</form>
									</div>
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
                                                                 <img src="images/coca.jpeg" width="100" height="150"/>
								...
								<div class="item-info-product ">
									<h4>
										<a href="view.jsp">Coca-Cola, 150ml</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">lkr450.00</span>
									...
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="cart.jsp" method="post">
											<fieldset>
												<input type="hidden" name="quantity" value="1" />
												<input type="hidden" name="hidden_name" value="Coca-Cola, 150ml" />
												<input type="hidden" name="hidden_price" value="450.00" />
												<input type="hidden" name="hidden_id"  value="009" />
												<input type="submit" name="add_to_cart" value="Add to cart" class="button" />
											</fieldset>
										</form>
									</div>
					...
					<div class="product-sec1">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
                                                                   <img src="images/sprite_.jpg" width="100" height="150"/>
								...
								<div class="item-info-product ">
									<h4>
										<a href="view.jsp">Pepsi , 150ml</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">lkr350.00</span>
									...
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="cart.jsp" method="post">
											<fieldset>
												<input type="hidden" name="quantity" value="1" />
												<input type="hidden" name="hidden_name" value="Pepsi , 150ml" />
												<input type="hidden" name="hidden_price" value="350.00" />
												<input type="hidden" name="hidden_id"  value="010" />
												<input type="submit" name="add_to_cart" value="Add to cart" class="button" />
											</fieldset>
										</form>
									</div>
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
                                                               <img src="images/creamsoda.jpeg" width="100" height="150"/>
								...
								<div class="item-info-product ">
									<h4>
										<a href="view.jsp">Cream Soda , 150ml</a>
									</h4>
									<div class="info-product-price">
									...
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="cart.jsp" method="post">
											<fieldset>
												<input type="hidden" name="quantity" value="1" />
												<input type="hidden" name="hidden_name" value="Cream Soda , 150ml" />
												<input type="hidden" name="hidden_price" value="150.00" />
												<input type="hidden" name="hidden_id"  value="011" />
												<input type="submit" name="add_to_cart" value="Add to cart" class="button" />
											</fieldset>
										</form>
									</div>
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
                                                                   <img src="images/maza-mango-drink-500x500.png" width="100" height="150"/>
								...
								<div class="item-info-product ">
									<h4>
										<a href="view.jsp"> Mango Drink , 100ml</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">lkr400.00</span>
									...
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="cart.jsp" method="post">
											<fieldset>
												...
												<input type="hidden" name="quantity" value="1" />
												<input type="hidden" name="hidden_name" value=" Mango Drink , 100ml" />
												<input type="hidden" name="hidden_price" value="400.00" />
												<input type="hidden" name="hidden_id"  value="012" />
												<input type="submit" name="add_to_cart" value="Add to cart" class="button" />
											</fieldset>
										</form>
									</div>
