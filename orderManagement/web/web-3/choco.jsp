...
<body>
	...
	<div class="privacy">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">Candies & Chocolates
				...
				<div class="wrapper">
					...
					<div class="product-sec1">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
                                                                  <img src="images/choco_4.jpg" width="100" height="150"/>
									...
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="cart.jsp" method="post">
											<fieldset>
												...
												<input type="hidden" name="hidden_name" value="Mars , 25g" />
												<input type="hidden" name="hidden_price" value="150.00" />
												<input type="hidden" name="hidden_id"  value="013" />
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
                                                                   <img src="images/choco_5.jpg" width="100" height="150"/>
								...
								<div class="item-info-product ">
									<h4>
										<a href="view.jsp">Diary Milk, 100g</a>
									</h4>
									<div class="info-product-price">
									...
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="cart.jsp" method="post">
											<fieldset>
												<input type="hidden" name="quantity" value="1" />
												<input type="hidden" name="hidden_name" value="Diary Milk, 100g" />
												<input type="hidden" name="hidden_price" value="200.00" />
												<input type="hidden" name="hidden_id"  value="014" />
												<input type="submit" name="add_to_cart" value="Add to cart" class="button" />
											</fieldset>
										</form>
									</div>
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
                                                                        <img src="images/dove.png" width="100" height="150"/>
								...
								<div class="item-info-product ">
									<h4>
										<a href="view.jsp">Dove..., 100g</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">lkr350.99</span>
									...
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="cart.jsp" method="post">
											<fieldset>
												<input type="hidden" name="quantity" value="1" />
												<input type="hidden" name="hidden_name" value="Dove..., 100g" />
												<input type="hidden" name="hidden_price" value="350.99" />
												<input type="hidden" name="hidden_id"  value="015" />
												<input type="submit" name="add_to_cart" value="Add to cart" class="button" />
											</fieldset>
										</form>
									</div>
					...
					<div class="product-sec1">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
                                                                  <img src="images/tobe.jpg" width="100" height="150"/>
								...
								<div class="item-info-product ">
									<h4>
										<a href="view.jsp">Toblerone , 100g</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">lkr425.00</span>
									...
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="cart.jsp" method="post">
											<fieldset>
												<input type="hidden" name="quantity" value="1" />
												<input type="hidden" name="hidden_name" value="Toblerone , 100g" />
												<input type="hidden" name="hidden_price" value="425.00" />
												<input type="hidden" name="hidden_id"  value="016" />
												<input type="submit" name="add_to_cart" value="Add to cart" class="button" />
											</fieldset>
										</form>
									</div>
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
                                                                    <img src="images/choco_1.jpg" width="100" height="150"/>
								...
								<div class="item-info-product ">
									<h4>
										<a href="view.jsp">Excellent , 100g</a>
									</h4>
									<div class="info-product-price">
									...
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="cart.jsp" method="post">
											<fieldset>
												<input type="hidden" name="quantity" value="1" />
												<input type="hidden" name="hidden_name" value="Excellent , 100g" />
												<input type="hidden" name="hidden_price" value="350.00" />
												<input type="hidden" name="hidden_id"  value="017" />
												<input type="submit" name="add_to_cart" value="Add to cart" class="button" />
											</fieldset>
										</form>
									</div>
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
                                       <img src="images/choco_2.jpg" width="100" height="150"/>
								...
								<div class="item-info-product ">
									...
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="cart.jsp" method="post">
											<fieldset>
												<input type="hidden" name="quantity" value="1" />
												<input type="hidden" name="hidden_name" value="Ghana, 68g" />
												<input type="hidden" name="hidden_price" value="250.00" />
												<input type="hidden" name="hidden_id"  value="018" />
												<input type="submit" name="add_to_cart" value="Add to cart" class="button" />
											</fieldset>
										</form>
									</div>
