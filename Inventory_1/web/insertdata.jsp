...
<body>
    <% 
           ...
           Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/grocery","root" ,"mango@7");
           Statement st = con.createStatement();
           
           st.executeUpdate("Insert into complaints_(cname,cid,type,title,des)values(?,?,?,?,?)");
...
<div class="wthree_agile_admin_info">
        ...
        <div style="align:left">
            <tr><td><h3>Main Menu</h3></td></tr>
            
            <tr><td><h3> <a href="complaints.jsp">Make complaints</a></h3></td></tr>
            <tr><td><h3><a href="viewComplaints.jsp">View complain Details</a></h3></td></tr>
