    ...
    <%!
              public class Add{
                 ...
                 public Add(){
                    try{
                        ...
                        query = "insert into supplier(sid,name,address,email,pid,phoneNo,quantity) values(?,?,?,?,?,?,?)";
                ...
                public int setNames(String sid, String name,String address,String email,String pid,String phoneNo,String quantity){
        ...
        <%
                ...
                String des = new String();
                   ...
                   result= lg.setNames(sid, name,address, email,pid,phoneNo,quantity);
		...
		<!-- /inner_content-->
          ...
          <script type="text/javascript">
                            function validate(){
                                ...
                                if(document.addSupplier.sid.value == ""){
                                     alert("Enter Supplier ID!");
                                     document.addSupplier.sid.focus();
                                     return false;
                                }
                                
                                if(document.addSupplier.name.value == ""){
                                     alert("Enter Supplier name!");
                                     document.addSupplier.name.focus();
                                     return false;
                                }
                               
                                if(document.addSupplier.address.value == ""){
                                     alert("Enter Address!");
                                     document.addSupplier.address.focus();
                                     return false;
                                }
                               ...
                               if(document.addSupplier.pid.value == ""){
                                     alert("Enter product ID!");
                                     document.addSupplier.pid.focus();
                                     return false;
                                }
                               ...
                               if(document.addSupplier.sid.value == ""){
                                     alert("Enter quantiy!");
                                     document.addSupplier.quantity.focus();
                                     return false;
                                }
