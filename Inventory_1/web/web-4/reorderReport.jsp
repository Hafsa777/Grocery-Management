...
<html lang="zxx">
    ...
    <body>
                    ...
                    <div class="agile_top_w3_post_sections">
                        <div class="col-md-6 agile_top_w3_post agile_info_shadow">
                            <div class="img_wthee_post">
                                <h3 class="w3_inner_tittle">view supplier List</h3>
        ...
        <%
            String supplier_s = request.getParameter("supplier");
            String product = request.getParameter("pro");
            String supplyDate = request.getParameter("suppD");
            String quantity = request.getParameter("quan");
            String time = request.getParameter("tl");
        %>
        ...
        <table border="0">
            <tbody>
                ...
                <p> Please send us the confirm order reply before <%=time%> Or else the order
                    will be sent to next supplier

                                <div class="stats-wrap">
                                    <div class="count_info"><h4 class="count"></h4><span class="year"></span></div>
                                    <div class="year-info"><p class="text-no"><a href="reorder.jsp">back</a></p><span class="year"></span></div>
                                    <div class="clearfix"></div>
                                </div>
