...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<!--pop-up-box-->
	<link href="popuo-box.css" rel="stylesheet" type="text/css" media="all" />
	<!--//pop-up-box-->
	<!-- price range -->
	<link rel="stylesheet" type="text/css" href="jquery-ui1.css">
	<!-- fonts -->
				...
				<ul>
					...
					<li>
						<a href="" data-toggle="modal" data-target="#myModal1">
							<span class="fa fa-truck" aria-hidden="true"></span>Bulk Order</a>
					</li>
					<li>
					...
					<li>
						<a href="signup.jsp" data-toggle="modal" data-target="#myModal2">
				...
				<div class="modal-body modal-body-sub_agile">
					...
					<div class="modal_body_left modal_body_left1">
						...
						<p>
							...
							<a href="login.jsp" data-toggle="modal" data-target="#myModal2">
								Sign Up Now</a>
						</p>
