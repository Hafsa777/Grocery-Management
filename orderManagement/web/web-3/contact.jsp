			...
			<div class="contact agileits">
				<div class="contact-agileinfo">
					<div class="contact-form wthree">
						<form action="contact_info.jsp" method="post">
							<div class="">
					...
					<div class="contact-right wthree">
						<div class="col-xs-7 contact-text w3-agileits">
							<h4>GET IN TOUCH :</h4>
							<p>
								<i class="fa fa-map-marker"></i> Baudhdhaloka Mavatha,Colombo 8</p>
							<p>
								<i class="fa fa-phone"></i> Telephone :  +94 222 3333</p>
							<p>
								<i class="fa fa-fax"></i> FAX :+94 11 4444 </p>
							<p>
